...
import com.udacity.shoestore.databinding.LayoutElementShowBinding
...
class ShoeListFragment : Fragment() {
    ...
    private fun initShoeList(listShoes: MutableList<Shoe>) {
        ...
        while (index < listShoes.size) {
            val shoeBinding: LayoutElementShowBinding = DataBindingUtil.inflate(
                layoutInflater,
                R.layout.layout_element_show,
                parentLayout,
                false
            )
